...
You will now implement passive imputation yourself using the *boys* dataset. The
*boys* dataset is distributed with **mice**, so you will be able to access these
data once you've loaded the **mice** package. The *boys* data are a subset of a
large Dutch dataset containing growth measures from the Fourth Dutch Growth Study. 
