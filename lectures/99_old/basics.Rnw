...
\begin{frame}[fragile]{\citet{little:1988_mcar} MCAR Test Example}

  Use the \citet{little:1988_mcar} MCAR test on MCAR data.
...
Use the \citet{little:1988_mcar} MCAR test on MAR data.
...
Use the \citet{little:1988_mcar} MCAR test on MNAR data.
