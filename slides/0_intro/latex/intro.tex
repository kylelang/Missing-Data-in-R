...
\hlstd{diabetes} \hlkwb{<-} \hlkwd{readRDS}\hlstd{(}\hlkwd{paste0}\hlstd{(dataDir,} \hlstr{"diabetes.rds"}\hlstd{))}

\hlcom{## Generate MAR missingness:}
\hlstd{diabetes}\hlopt{$}\hlstd{m} \hlkwb{<-} \hlkwd{simLogisticMissingness0}\hlstd{(}\hlkwc{data}    \hlstd{= diabetes,}
...
\hlstd{fit} \hlkwb{<-} \hlstd{diabetes} \hlopt{%>%}
...
{\centering \includegraphics[width=\maxwidth]{figure/intro-unnamed-chunk-32-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/intro-unnamed-chunk-33-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/intro-unnamed-chunk-34-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/intro-unnamed-chunk-35-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/intro-unnamed-chunk-41-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/intro-unnamed-chunk-42-1} 
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in fortify(data): object 'datS' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error: geom\_point requires the following missing aesthetics: x and y}}\end{kframe}

{\centering \includegraphics[width=\maxwidth]{figure/intro-unnamed-chunk-43-1} 
...
{\centering \includegraphics[width=0.65\linewidth]{figure/intro-unnamed-chunk-47-1} 
...
{\centering \includegraphics[width=0.65\linewidth]{figure/intro-unnamed-chunk-50-1} 
