...
\begin{frame}[allowframebreaks]{Coverage Measures}
  ...
  \end{align*}
  \begin{itemize}
  \item The proportion of observed cells in $Y$ that exists in cases for which $Y_j$ is missing 
  \item How well the missing values in $Y_j$ connect to the observed values in $Y_{-j}$
  \end{itemize}
